...
def posts():
    if request.method == 'POST':
        ...
        new_post = Connectblog(title=post_title,
        ...
        all_posts = Connectblog.query.order_by(Connectblog.posted_on).all()
...
def edit(id):
    to_edit = Connectblog.query.get_or_404(id)
    if request.method == 'POST':
...
def delete(id):
    to_delete = Connectblog.query.get_or_404(id)
